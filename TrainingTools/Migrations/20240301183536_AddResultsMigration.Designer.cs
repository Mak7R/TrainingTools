...
namespace TrainingTools.Migrations
{
    ...
    [Migration("20240301183536_AddResultsMigration")]
    partial class AddResultsMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Contracts.Models.ExerciseResultEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("ExerciseResultsId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ExerciseResultsId");

                    b.ToTable("ExerciseResultEntries");
                });
            ...
            modelBuilder.Entity("Contracts.Models.ExerciseResultEntry", b =>
                {
                    b.HasOne("Contracts.Models.ExerciseResults", null)
                        .WithMany("Results")
                        .HasForeignKey("ExerciseResultsId");
                });

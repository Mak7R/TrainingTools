...
public class AccountController : Controller
{
    ...
    public async Task<IActionResult> Login([FromForm] LoginDto loginDto, string? returnUrl)
    {
        ...
        else
        {
            ...
            ModelState.AddModelError("Login",
                "If you haven't this letter. If you have written correct email you can get new confirmation letter. Go to help and click to resend confirmation email letter");
        }
    ...
    {
        if (userName == null) return Json(false);

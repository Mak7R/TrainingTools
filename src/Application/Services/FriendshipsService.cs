...
public class FriendshipsService : IFriendsService
{
    ...
    public FriendshipsService(IRepository<FriendInvitation, (Guid, Guid)> friendInvitationsRepository,
        IRepository<Friendship, (Guid, Guid)> friendshipsRepository, ILogger<FriendshipsService> logger)
    {
    ...
    public async Task<IEnumerable<FriendInvitation>> GetInvitationsFor(ApplicationUser user)
    {
        ...
        return await _friendInvitationsRepository.GetAll(new FilterModel
            { { FilterOptionNames.Relationships.FriendInvitation.Invited, user.Id.ToString() } });
    }
    ...
    public async Task<IEnumerable<FriendInvitation>> GetInvitationsOf(ApplicationUser user)
    {
        ...
        return await _friendInvitationsRepository.GetAll(new FilterModel
            { { FilterOptionNames.Relationships.FriendInvitation.Invitor, user.Id.ToString() } });
    }
